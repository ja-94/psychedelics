...
eid = 'a1d9a3a6-873c-47fe-9350-6c87876a5669'
#eid = eids[6]
...
plt.axvline(x = 18.10, color = 'red', label = 'LSD administration (150ug/Kg)', linestyle='solid')
...
plt.savefig('D:/Psychedelics/Figures_Pupil/'f'{subject}_{date}.png', bbox_inches='tight')
plt.savefig('D:/Psychedelics/Figures_Pupil/'f'{subject}_{date}.pdf', bbox_inches='tight')
